...
const Checkout = () => {
    const {handleChange, onSubmit, user, changeUserInfo, confirmUser, fin, localError} = useUserContext();
    ...
    return (
        ...
        { confirmUser ?
            <div className="d-flex flex-column justify-content-center">
                <h2 className='text-center'>Tu compra se ha completado con exito</h2>
                    ...
                    <form className="w-100" onSubmit = {onSubmit}>
                        <fieldset> 
                            <div className="col m-2 w-100">
                                ...
                                <span className='text-danger fst-italic fw-medium'>{localError.nombre}</span>
                            </div>
                            <div className="col-md-6 w-100 m-2">
                                ...
                                <span className='text-danger fst-italic fw-medium'>{localError.email}</span>
                            </div>
                            <div className="col-md-6 w-100 m-2">
                                <label htmlFor="direccion" className="form-label">Direccion</label>
                                <input type="text" name="direccion"  className="form-control" id="direccion" onChange={handleChange} />
                                <span className='text-danger fst-italic fw-medium'>{localError.direccion}</span>
                            </div>
                        </fieldset>
